...
int main()
{
    ...
    Shader shader_box("../src/08_phong/lighting.vs", "../src/08_phong/lighting.frag");
    Shader shader_lamp("../src/08_phong/lamp.vs", "../src/08_phong/lamp.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        modelLoc = glGetUniformLocation(shader_lamp.Program, "model");
        viewLoc = glGetUniformLocation(shader_lamp.Program, "view");
        projLoc = glGetUniformLocation(shader_lamp.Program, "projection");
        // Set matrices
        glUniformMatrix4fv(viewLoc, 1, GL_FALSE, glm::value_ptr(view));
        glUniformMatrix4fv(projLoc, 1, GL_FALSE, glm::value_ptr(projection));
