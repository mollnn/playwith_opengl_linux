...
int main()
{
    ...
    Shader lightingShader("../src/11_multilights/lighting.vs", "../src/11_multilights/lighting.frag");
    Shader lampShader("../src/11_multilights/lamp.vs", "../src/11_multilights/lamp.frag");
    ...
    unsigned char *image;
    // Diffuse map
    image = SOIL_load_image("../src/11_multilights/container2.png", &width, &height, 0, SOIL_LOAD_RGB);
    ...
    // Specular map
    image = SOIL_load_image("../src/11_multilights/container2_specular.png", &width, &height, 0, SOIL_LOAD_RGB);
