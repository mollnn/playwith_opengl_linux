...
int main()
{
    ...
    Shader shader("../src/10_lightmap/phong.vs", "../src/10_lightmap/phong.frag");
    ...
    unsigned char *image;
    // Diffuse map
    image = SOIL_load_image("../src/10_lightmap/container2.png", &width, &height, 0, SOIL_LOAD_RGB);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(lightAmbientLoc, 10.0f, 10.0f, 10.0f);
